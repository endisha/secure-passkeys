    ...
    <div class="col-md-4">
      ...
      <div
        ...
        <div class="detail">
          ...
          <span class="desc"><?php esc_html_e('Users', 'secure-passkeys'); ?></span>
        </div>
      </div>
      ...
      <div
        ...
        <div class="icon">
          <svg
            ...
            <path
              d="M2.743 4.757a3.757 3.757 0 1 1 5.851 3.119 5.991 5.991 0 0 1 2.15 1.383c.17.17.257.405.258.646.003.598.001 1.197 0 1.795L11 12.778v.721a.5.5 0 0 1-.5.5H1.221a.749.749 0 0 1-.714-.784 6.004 6.004 0 0 1 3.899-5.339 3.754 3.754 0 0 1-1.663-3.119Z"></path>
            <path
        ...
        <div class="detail">
          ...
          <span class="desc"><?php esc_html_e('Passkeys', 'secure-passkeys'); ?></span>
        </div>
      </div>
      <div
        ...
        <div class="detail">
          ...
          <span class="desc"><?php esc_html_e('Activities', 'secure-passkeys'); ?></span>
        </div>
      </div>
      ...
      <div
        ...
        <div class="detail">
          ...
          <span class="desc"><?php esc_html_e('Challenges', 'secure-passkeys'); ?></span>
        </div>
      </div>
    </div>
        ...
        <div class="panel-body">
          <div class="list-group-empty" v-if="isLoading">
            <i
              ...
              style="text-align: center; margin: auto"></i>
          </div>
