...
?>
<div class="secure-passkey-login-short-code-wrapper <?php echo esc_attr($extra_wrapper_classes ?? ''); ?>" id="secure-passkey-login-wrapper">
    ...
    <button id="login-via-passkey" class="button button-large login-via-passkey <?php echo esc_attr($extra_button_classes ?? ''); ?>">
